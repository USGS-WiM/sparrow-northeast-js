...
var serviceBaseURL =
    "https://sparrowtest.wim.usgs.gov/arcgis/rest/services/SparrowNortheast/SparrowNortheast/MapServer/"; //important! UPDATE rest service URL
...
var sedimentCalibrationURL = rootURL + "northeast_calibration_sites_ss.zip";
...
var catchmentDefinitions_q = {
    ...
    incy: "IncreStreamflow,  Incremental   yield (mm/yr)",
