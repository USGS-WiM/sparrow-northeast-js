...
# SPARROW Northeast Nutrient Loading
...
```
git clone https://github.com/USGS-WiM/sparrow-northeast-js.git
```

Change to the new newly created directory

```
cd sparrow-northeast-js
```
...
* WIM is a part of the [Upper Northeast Water Science Center](https://www.usgs.gov/centers/wisconsin-water-science-center).